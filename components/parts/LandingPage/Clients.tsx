export const Clients = () => {
  const logos = [
    ...
    { src: '/logos/african-institute-for-mathematical-sciences-aims-rwanda-308247 1.png', alt: 'AIMS Rwanda' },
    { src: '/logos/clean cooking networking.png', alt: 'Clean Cooking Networking' },
    { src: '/logos/compassion international.png', alt: 'Compassion International' },
        ...
        <div className="clients-inner">
          {marqueeLogos.map((logo, i) => (
            <div key={i} className="client-item">
              <img src={logo.src} alt={logo.alt} style={{ height: 40, width: 'auto' }} />
            </div>
          ))}
        </div>
      </div>
