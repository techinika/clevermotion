    ...
    <div className="anim-fadein max-w-lg mx-auto">
      ...
      <div className="flex items-center gap-3 mb-8 p-3 rounded-xl anim-fadeup"
        ...
        <div>
          ...
          <p className="font-mono-cm text-[0.58rem] tracking-[0.12em] uppercase mt-0.5" style={{ color: "rgba(229,9,20,.6)" }}>
      ...
      <div className="text-center mb-8 anim-fadeup d-1">
        <div className="inline-flex items-center justify-center w-14 h-14 rounded-full mb-5 relative"
          ...
          <span className="text-[#E50914]"><Icon.Lock /></span>
        </div>
        ...
        <p className="font-mono-cm text-[0.6rem] tracking-[0.12em] mt-1" style={{ color: "rgba(229,9,20,.55)" }}>
          Delivering to: {email}
        </p>
      </div>
      ...
      <button
        ...
        style={{
          background: code.length === 6 && !loading && attempts < MAX_ATTEMPTS ? "#E50914" : "rgba(229,9,20,.25)",
